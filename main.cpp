...
const std::string MODEL_PATH = "models/180212_Erik_XIV_Rustning_2.obj";
const std::string TEXTURE_PATH = "textures/180212_Erik_XIV_Rustning_2_u1_v1.png";
...
private:
    ...
    void transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout) {
        ...
        if (oldLayout == VK_IMAGE_LAYOUT_UNDEFINED && newLayout == VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL) {
            ...
            sourceStage = sourceStage = VK_PIPELINE_STAGE_TOP_OF_PIPE_BIT;
    ...
    void updateUniformBuffer(uint32_t currentImage) {
        ...
        ubo.view = glm::lookAt(glm::vec3(15.0f, 30.0f, 45.0f), glm::vec3(0.0f, 0.0f, 15.0f), glm::vec3(0.0f, 0.0f, 1.0f));
